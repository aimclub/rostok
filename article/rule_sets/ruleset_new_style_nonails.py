...
def create_rules():
    ...
    radial_move_values = [0.8, 1.2, 1.6]
    ...
    create_all_rules("AddFinger", ["F"], [ ["RT1", "RT2", "RT3"], ["RE"], ["FG"]],
                     0,
                     0, [(0, 1), (1, 2)])
    rule_vocab.create_rule("RemoveFinger", ["F"], [], 0, 0, [])

    create_all_rules("AddFinger_R", ["RF"], [["RE"], ["RT1", "RT2", "RT3"], ["RE"], ["FG"]],
                     0,
                     0, [(0, 1), (1, 2), (2, 3)])
