...
from obj_grasp.objects import get_obj_hard_mesh_piramida
from rule_sets import ruleset_old_style_graph_nonails
...
report = load_saveable(Path("results\Reports_23y_02m_27d_11H_49M_graph_oldrule_pyramida\MCTS_data_windows.pickle"))
