...
for get_graph in mechs:
    ...
    controll_parameters = {"initial_value": [0, 0, 100, 0, 0, 0 ,0 ,0, 0, 0], "sin_parameters" : [[0.000, 0.1, 0.1], [0.000, 0.1, 0.2],[0.000, 0.1, 0.1],[0.000, 0.1, 0.1],[0.000, 0.1, 0.1],[0.000, 0.1, 0.1],[0.000, 0.1, 0.1],[0.000, 0.1, 0.1],[0.000, 0.1, 0.1],[0.000, 0.1, 0.1]]}
