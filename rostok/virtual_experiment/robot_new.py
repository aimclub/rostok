...
class RobotChrono:
    ...
    def __init__(self,
        ...
        self.data_storage.add_data_type("n_contacts", self.__built_graph.body_map_ordered)
        self.data_storage.add_data_type("forces", self.__built_graph.body_map_ordered)
