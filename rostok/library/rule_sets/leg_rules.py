...
def create_rules(tendon=False, smc=False):
    ...
    dummy_link = PrimitiveBodyBlueprint(
        Box(0.01, 0.001, 0.01), material=def_mat, density=10000)
    ...
    revolve = RevolveJointBlueprint(
        JointInputType.UNCONTROL, stiffness=0.01, damping=0)
    revolve_base = RevolveJointBlueprint(
        JointInputType.UNCONTROL, stiffness=0.01, damping=0)
    # Nodes
