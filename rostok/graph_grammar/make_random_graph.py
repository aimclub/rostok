...
def make_random_graph(n_iter: int,
                      rule_vocab: rule_vocabulary.RuleVocabulary,
                      use_nonterminal_only: bool = True):
    ...
    If use_nonterminal_only is True all applied rules are True, if it is Flase, first half of rules
    will be nonterminal and
