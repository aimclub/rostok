...
from rostok.library.obj_grasp.objects import (get_object_ellipsoid, get_object_sphere,
                                            get_object_parametrized_cuboctahedron, get_object_parametrized_dipyramid_3, get_object_parametrized_trapezohedron, get_obj_hard_mesh_trapezohedron)
...
grasp_object_blueprint = get_object_parametrized_trapezohedron(0.13)
grasp_object_blueprint = get_obj_hard_mesh_trapezohedron()
