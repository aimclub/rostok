...
def config_with_standard(grasp_object_blueprint):
    ...
    control_optimizer = CounterWithOptimizationDirect(simulation_manager, simulation_rewarder, hp.CONTROL_OPTIMIZATION_BOUNDS,hp.CONTROL_OPTIMIZATION_ITERATION)
...
def config_with_standard_graph(grasp_object_blueprint, torque_dict):
    ...
    control_optimizer = CounterGraphOptimization(simulation_manager, simulation_rewarder, torque_dict)
