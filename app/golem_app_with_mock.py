...
from golem.core.optimisers.genetic.operators.base_mutations import (MutationStrengthEnum, tree_growth)
from golem.core.optimisers.genetic.operators.regularization import \
    RegularizationTypesEnum
from golem.core.optimisers.genetic.operators import base_mutations
...
from preapare_evo import load_init_population, terminal_nodes, custom_mutation_add, custom_mutation_del, create_balance_population, rule_vocab
...
boxer = get_object_box(1.2, 0.5, 0.8, 0)
