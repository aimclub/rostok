...
app_node_vocab.create_node(label="J1", is_terminal=True, block_wrapper=revolve1)
...
app_node_vocab.create_node(label="T1", is_terminal=True, block_wrapper=transform_mx_plus)
app_node_vocab.create_node(label="T2", is_terminal=True, block_wrapper=transform_mz_plus_x_minus)
app_node_vocab.create_node(label="T3", is_terminal=True, block_wrapper=transform_mzx_plus)
app_node_vocab.create_node(label="T4", is_terminal=True, block_wrapper=transform_mzx_minus)


app_rule_vocab = rule_vocabulary.RuleVocabulary(app_node_vocab)

app_rule_vocab.create_rule("FlatCreate", ["ROOT"], ["F"], 0 , 0)
app_rule_vocab.create_rule("Mount", ["F"], ["F", "M", "EM"], 0 , 0, [(0,1), (1,2)])
app_rule_vocab.create_rule("MountAdd", ["M"], ["M", "EM"], 0 , 1, [(0,1)])
app_rule_vocab.create_rule("FingerUpper", ["EM"], ["J", "L", "EM"], 0 , 2, [(0,1), (1,2)])
...
list_Palm = list(map(app_node_vocab.get_node, ["F1"]))
