...
from rostok.library.rule_sets.simple_designs import get_one_finger_one_link, get_one_finger_one_nlink, get_two_link_three_finger, get_one_finger_one_link, get_three_link_one_finger, get_three_same_link_one_finger, get_four_same_link_one_finger
...
if not vis:
    ...
    velocity_data = simulation_output.robot_final_ds.get_data("body_velocity")[
        velocity_data_idx[-1]]
