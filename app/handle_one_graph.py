...
from rostok.library.rule_sets.simple_designs_nsc import (get_two_link_three_finger, get_two_same_link_one_finger)
...
grasp_object_blueprint = get_object_ellipsoid(0.1, 0.1, 0.2, 0)
...
simulation_output: SimulationResult = simulation_manager.run_simulation(
    graph, data, [[-45.0, 0], [-45, 0], [-45, 0]], vis, True)
