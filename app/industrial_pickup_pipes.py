...
from rostok.criterion.flags_simualtions import FlagMaxTime, FlagSlipout, FlagNotContact, FlagFlyingApart
...
cfg.time_step = 0.005
cfg.time_sim = 1.5
cfg.flags = [FlagMaxTime(1), FlagNotContact(1.5/4-0.2), FlagSlipout(1.5/4+0.2, 0.2), FlagFlyingApart(4)]
