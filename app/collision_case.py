...
from rostok.library.obj_grasp.objects import get_object_box, get_object_cylinder, get_object_ellipsoid, get_object_parametrized_sphere
...
grasp_object_blueprint = get_object_ellipsoid(1.3, 0.9, 0.8, 0)
grasp_object_blueprint = get_object_cylinder(0.55, 0.8,0)
